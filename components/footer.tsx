        ...
        <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
          <div className="grid grid-cols-2 gap-8 md:grid-cols-4">
            <div>
              ...
              <ul className="mt-4 space-y-4">
                <li><Link href="#" className="text-base text-gray-300 hover:text-white">Solar Panels</Link></li>
                <li><Link href="#" className="text-base text-gray-300 hover:text-white">Inverters</Link></li>
                <li><Link href="#" className="text-base text-gray-300 hover:text-white">Batteries</Link></li>
                <li><Link href="#" className="text-base text-gray-300 hover:text-white">Accessories</Link></li>
              </ul>
            </div>
            <div>
            ...
            <div>
              ...
              <ul className="mt-4 space-y-4">
                <li><Link href="/about-us" className="text-base text-gray-300 hover:text-white">About</Link></li>
          ...
          <div className="mt-8 border-t border-gray-700 pt-8 md:flex md:items-center md:justify-between">
            ...
            <p className="mt-8 text-base text-gray-400 md:mt-0 md:order-1">
              &copy; 2024 Metclan Technologies, All rights reserved.
            </p>
          </div>
        </div>
      </footer>
